...
transition: ease-in 2ms;
        ...
        .page-container {
            ...
            /* Horizontally centers the child in the flex container */
            align-items: center;
            /* Vertically centers the child in the flex container */
            height: 100vh;
        ...
        .checks ul {
            ...
            /* Adjust the padding for the text */
            .checks ul li {
...
<body data-spy="scroll" data-target=".mainmenu-area">
    ...
    <nav class="mainmenu-area nav lg-container h-24 0 flex items-center font-semibold text-white justify-between"
        data-spy="affix" data-offset-top="200">
        <div class="flex m-5 items-center justify-between w-full h-24 ">
            ...
            <div class="ml-7 hidden md:flex items-center space-x-4 ">
                <ul class="flex text-gray-700 text-lg font-md items-center">
                    {{-- <a href="#"><li class="ml-7 ">Home</li></a> --}}
                    <a href="/features">
                        <li class="ml-7 ">Features</li>
                    </a>
                    <a href="pricing">
                        <li class="ml-7 ">Pricing</li>
                    </a>
                    <a href="/customers-case-studies">
                        <li class="ml-7 ">Customers</li>
                    </a>
                    <a href="#">
                        <li class="ml-7 ">Solution <i class="fa-solid fa-caret-down"></i></li>
                    </a>
                    <a href="/contactUs">
                ...
                <div class="flex space-x-4 relative group ">
                    <a href="#"
                        class="bg-blue-900 text-white px-4 py-2 rounded-md hover:bg-blue-800 transition duration-300">
                        Start Your Free Trial
                    </a>
                    <a href="/Book-a-demo"
                        class="border border-blue-900 text-blue-900 px-4 py-2 rounded-md hover:bg-blue-100 transition duration-300">
                        Book a Demo
                    </a>
                </div>
            </div>
        ...
        <!-- Mobile menu -->
        <div id="mobile-menu"
            class="md:hidden hidden bg-white absolute top-24 left-0 right-0 shadow-md transition-all duration-300 ease-in-out">
            <ul class="flex flex-col text-gray-700 text-lg font-medium">
                ...
                <li><a href="#" class="block py-2 px-4 hover:bg-gray-100">Solution <i
                            class="fa-solid fa-caret-down"></i></a></li>
                <li><a href="/contactUs" class="block py-2 px-4 hover:bg-gray-100">Contact</a></li>
            </ul>
            <div class="p-4 space-y-2">
                <a href="#"
                    class="block w-full bg-blue-900 text-white px-4 py-2 rounded-md hover:bg-blue-800 transition duration-300 text-center">
                    Start Your Free Trial
                </a>
                <a href="/Book-a-demo"
                    class="block w-full border border-blue-900 text-blue-900 px-4 py-2 rounded-md hover:bg-blue-100 transition duration-300 text-center">
                    Book a Demo
                </a>
            </div>
        </div>
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-6">
                    <div>
                        ...
                        <ul class="dark:text-gray-400 font-semibold">
                            ...
                            <li class="mb-4"><a href="#" class="hover:underline">Financial management</a>
                            </li>
                            <li class="mb-4"><a href="#" class="hover:underline">Exam Management</a></li>
                            <li class="mb-4"><a href="#" class="hover:underline">Transport Management</a>
                            </li>
                            ...
                            <li class="mb-4"><a href="#" class="hover:underline">Student portal/Guardian
                                    portal</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="text-white dark:text-gray-400 font-medium">
                            ...
                            <li class="mb-4"><a href="#" class="hover:underline">Terms &amp; Conditions</a>
                            </li>
            ...
            <div class="flex flex-col items-center justify-center">
                <div class="flex flex-col sm:flex-row text-sm mb-4 text-center sm:text-left">
                    <p class="mb-2 sm:mb-0 sm:mr-4">Email: <a href="mailto:sales.somaplus@gmail.com"
                            class="hover:underline">sales.somaplus@gmail.com</a></p>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tabs.forEach(function(tab) {
                tab.addEventListener('click', function(e) {
                    let targetId = tab.id.replace('tab', 'content'); // Changed to lowercase 'tab'
                    ...
                    tab.classList.add('font-semibold', 'text-blue-600', 'bg-indigo-100',
                        'border-r-4', 'border-indigo-700');
                    tab.classList.remove('text-gray-800');
                });
            });

            // Set the first tab and content as active initially
            tabs[0].classList.add('font-semibold', 'text-blue-600', 'bg-indigo-100', 'border-r-4',
                'border-indigo-700');
            contents[0].classList.remove('hidden');
        });
    </script>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.5.1/flowbite.js"
