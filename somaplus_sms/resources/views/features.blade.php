...
<div class="bg-purple-300 min-h-7/8 flex flex-col items-center justify-center w-full px-4 py-16 md:py-24">
    <div class="flex leading-10 mt-6  text-center font-sans py-10 text-white flex-col items-center justify-center max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-8">
            ...
            <button class="border border-blue-900 text-blue-900 px-6 py-2 rounded-md hover:bg-blue-100 transition duration-300">
                Book a Demo
            </button>
        </div>
    </div>
...
<div class="container mx-auto px-4 py-16 md:py-24">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-lg p-6 shadow-sm flex flex-col items-start justify-center border-2 transition duration-300 hover:shadow-lg">
            <p class="text-2xl bg-indigo-800 p-5 rounded-full h-16 w-16 flex items-center justify-center text-white mb-7">{{ $feature['icon'] }}</p>
            ...
            <a href="#" class="text-indigo-600 hover:underline transition duration-300">Read more <i class="fas fa-arrow-right ml-1"></i></a>
        </div>
        @endforeach
    </div>
</div>
...
<div class="container mx-auto px-4 py-16 md:py-24">
    <div class="flex flex-col md:flex-row items-center justify-between">
        <div class="w-full md:w-1/2 mb-8 md:mb-0">
            ...
            <button class="w-full md:w-auto text-white font-bold bg-purple-500 p-4 rounded-xl hover:bg-purple-600 transition duration-300">
                Download Our Proposal
            </button>
        </div>
        <div class="w-full md:w-1/2">
            <img src="{{ asset('path_to_your_image.jpg') }}" alt="Product Documentation" class="w-full h-auto rounded-lg shadow-lg"/>
        </div>
    </div>
</div>
