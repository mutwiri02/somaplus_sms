   ...
   <div class="home">
    <div class="container mx-auto px-4 h-screen flex flex-col justify-center items-center">
        <div class="flex flex-col md:flex-row justify-center items-center h-full w-full">
            ...
            <!-- Right column -->
            <div class="md:hidden sm:hidden w-full mt-10 md:mt-0 flex justify-center md:justify-end">
                <img src="{{asset('images/spj.png')}}" class="w-full max-w-md" alt="logo"/>
            </div>
        </div>
    </div>
...
<div class="container mx-auto px-4 py-8 mb-16">
    ...
    <div id="keen-slider" class="keen-slider">
        <div class="keen-slider__slide flex items-center justify-center px-4 md:px-2">
            <img src="http://master.somaplus.net/somaplus-docs/01J3NJQNVYWN6Z0DQS12NWR74S.png" alt="OR Logo" class="h-16 sm:h-20 md:h-28 object-contain">
        </div>
        <div class="keen-slider__slide flex items-center justify-center px-4 md:px-2">
            <img src="http://master.somaplus.net/somaplus-docs/80gFCRu1av5IVIYl4HpE4v9Ygz09YM-metadmluZSBsb2dvLnBuZw==-.png" alt="Recom Logo" class="h-16 sm:h-20 md:h-28 object-contain">
        </div>
        <div class="keen-slider__slide flex items-center justify-center px-4 md:px-2">
            <img src="http://master.somaplus.net/somaplus-docs/01HKPXRWC03DMWTXFKSPHQ0TYE.jpg" alt="Lone Star Bakery Logo" class="h-16 sm:h-20 md:h-28 object-contain">
        </div>
        <div class="keen-slider__slide flex items-center justify-center px-4 md:px-2">
            <img src="http://master.somaplus.net/somaplus-docs/NqUbvnLlTUL05GArYQXv0CCqb6VoiI-metaMjkxNjg1NjIxXzM2NTExMjM5MjQyNzU0N18xNTEwNjg2NjMxNjMzNTI4MTg1X24uanBn-.jpg" alt="Berridge Logo" class="h-16 sm:h-20 md:h-28 object-contain">
        </div>
        <div class="keen-slider__slide flex items-center justify-center px-4 md:px-2">
            <img src="http://master.somaplus.net/somaplus-docs/01HT02SQNAWRC0XWEB815QR1YT.jpg" alt="RC Logo" class="h-16 sm:h-20 md:h-28 object-contain">
        </div>
        <div class="keen-slider__slide flex items-center justify-center px-4 md:px-2">
            <img src="http://master.somaplus.net/somaplus-docs/01J0JSFGWNWX7CMH8MXJ5F43EP.png" alt="RC Logo" class="h-16 sm:h-20 md:h-28 object-contain">
        </div>
    </div>
</div>
...
@endif --}}
        ...
        <div class="mb-6 -mt-32">
            <div class="relative bg-white w-full sm:w-2/3 md:mx-10 wow fadeInUp mx-auto  mb-7   border border-gray-600 rounded-lg shadow-lg" data-wow-delay="1.0s">
                <div class="flex flex-col lg:flex-row wow fadeInUp leading-10 text-center font-sans text-white items-center justify-center p-6 lg:p-10" data-wow-delay="1.2s">
                    <div class="checks flex w-full lg:w-3/4 items-start leading-loose text-gray-800 lg:mr-7 flex-col justify-start mb-8 lg:mb-0">
                        <h1 class="text-2xl sm:text-3xl font-semibold pb-8">Features</h1>
                        <ul class="leading-loose">
                            <li class="flex items-center mb-6 text-lg sm:text-xl"><i class="fa-solid fa-check text-green-600 mr-3 text-2xl"></i><p class="list">Student Attendance Tracking</p></li>
                            <li class="flex items-center mb-6 text-lg sm:text-xl"><i class="fa-solid fa-check text-green-600 mr-3 text-2xl"></i><p class="list">Gradebook Management</p></li>
                            <li class="flex items-center mb-6 text-lg sm:text-xl"><i class="fa-solid fa-check text-green-600 mr-3 text-2xl"></i><p class="list">Fee Management System</p></li>
                        </ul>
                        <a class="text-base sm:text-lg font-semibold text-purple-700 mt-6" href="#">Read More <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
        ...
        <div class="container mx-auto px-4 py-20">
            <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="w-full md:w-1/2 mb-8 md:mb-0">
                    <img src="https://media.istockphoto.com/id/1358280405/photo/confident-businessman-in-his-office.webp?b=1&s=612x612&w=0&k=20&c=vOxIbYZZ9mgdPp6tfCAw4aSEbzLwsXmah_O_FCekusw=" alt="School management system in action" class="rounded-lg shadow-lg w-full h-auto object-cover">
                </div>
        
                <!-- Content Section -->
                <div class="w-full md:w-1/2 md:pl-12 flex flex-col justify-center">
                    <h2 class="text-4xl font-bold text-gray-900 mb-4 text-center md:text-left">Seamless School Operations</h2>
                    <p class="text-xl font-semibold text-gray-700 mb-4 text-center md:text-left">SomaPlus: Your All-in-One Solution</p>
                    <p class="text-gray-600 text-xl mb-6 text-center md:text-left">
                        Say goodbye to operational disruptions with SomaPlus. Our system ensures that your school runs smoothly with features like automated attendance tracking, real-time notifications, and comprehensive reporting tools, all designed to keep your administration efficient and your staff informed.
                    </p>
                    <div class="flex justify-center md:justify-start">
                        <button class="bg-indigo-900 text-white font-semibold py-2 px-4 rounded-md hover:bg-indigo-800 transition duration-300">
    ...
    <div class="container mb-10 mx-auto p-16">
        <div class="flex flex-col md:flex-row justify-between mb-8">
            ...
            <div class="md:w-2/3 mb-14">
                <p class="text-2xl italic font-bold text-gray-900">
                    "With SomaPlus, I can easily manage Finances and communicate with parents, even on short notice. Their support team is always there when I need them, ensuring everything runs smoothly."
                </p>
            </div>
        </div>
            ...
            <div class="w-full max-w-5xl p-8">
                <div class="flex flex-col md:flex-row border border-gray-400 rounded-lg overflow-hidden">
                    <div class="flex-1 p-8 sm:p-14 border-b md:border-b-0 md:border-r border-gray-400">
                        ...
                        <p class="text-blue-300 mb-4">SomaPlus ensures your school’s system is always up and running with our robust infrastructure and proactive support.</p>
                    ...
                    <div class="flex-1 p-8 sm:p-14 border-b md:border-b-0 md:border-r border-gray-400">
                        ...
                        <p class="text-blue-300 mb-4">Keep track of student attendance and staff activity with SomaPlus’s live monitoring and detailed reports.</p>
                        <div class="flex justify-end">
                            <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-900" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                    ...
                    <div class="flex-1 p-8 sm:p-14">
                        ...
                        <p class="text-blue-300 mb-4">Receive notifications for important events, from attendance issues to system updates, ensuring you’re always in the loop.</p>
                        <div class="flex justify-end">
                            <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-900" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
        ...
        <div class="container mx-auto px-4 sm:px-14 mt-16 py-8 flex flex-col items-center justify-center">
            <div class="flex w-full flex-col md:flex-row justify-between items-center mb-4">
                <div class="mb-4 md:mb-0">
                    ...
                    <p class="text-gray-500 mt-2">Designed to streamline your school management and enhance communication with SomaPlus.</p>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-12 p-4 sm:p-14">
                <div>
                    ...
                    <p class="text-gray-500 mb-4">Easily manage class schedules, staff shifts, and more with SomaPlus, accessible from your phone or laptop.</p>
                ...
                <div>
                    ...
                    <p class="text-gray-500 mb-4">Enhance communication with SomaPlus by sending mass announcements, private messages, and more to staff and students.</p>
                    <a href="#" class="text-purple-500 font-semibold flex items-center">
                        Learn More
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                ...
                <div>
                    ...
                    <p class="text-gray-500 mb-4">Automate your billing process with SomaPlus, ensuring accurate timesheets and quick approvals.</p>
                    <a href="#" class="text-purple-500 font-semibold flex items-center">
                        Learn More
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
        ...
        <div>
         ...
         <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-col space-y-12 md:space-y-0 md:flex-row justify-between items-start md:items-center md:space-x-8 mt-12">
                ...
                <div class="flex-1 flex flex-col items-start md:items-start">
                    <div class="mb-4">
                        <svg class="w-12 h-12 text-indigo-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c1.104 0 2-.896 2-2s-.896-2-2-2-2 .896-2 2 .896 2 2 2zm0 4c-3.313 0-6 2.687-6 6v2h12v-2c0-3.313-2.687-6-6-6zm0 10H6v-1c0-2.667 2.333-5 5-5s5 2.333 5 5v1h-6z"></path>
                        </svg>
                    </div>
                    ...
                    <p class="text-gray-900 text-lg  md:text-left">
                        After the client accepts onboarding, we begin by creating the school account and handling data entry.
                    </p>
                </div>
                ...
                <div class="flex-1 flex flex-col items-start md:items-start">
                    <div class="mb-4">
                        <svg class="w-12 h-12 text-indigo-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h18v12H3V3zm0 15h18v2H3v-2zm0 0V5h18v13h-1V7H4v11H3z"></path>
                        </svg>
                    </div>
                    <h2 class="text-xl  font-bold text-center md:text-left mb-4 text-indigo-800">Training</h2>
                    <p class="text-gray-900 text-lg  md:text-left">
                        We provide comprehensive training on the SomaPlus system to ensure seamless integration into your operations.
                    </p>
                </div>
                ...
                <div class="flex-1 flex flex-col items-start md:items-start">
                    <div class="mb-4">
                        <svg class="w-12 h-12 text-indigo-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7a4 4 0 011-1 4 4 0 014-4 4 4 0 014 4 4 4 0 014 4v7.04a4.1 4.1 0 01-2.036.6H7.036A4.1 4.1 0 015 18.04V11a4 4 0 01-1-4zm7 1a1 1 0 10-2 0 1 1 0 002 0zm-1 9a3 3 0 003-3 3 3 0 00-3-3 3 3 0 00-3 3 3 3 0 003 3z"></path>
                        </svg>
                    </div>
            ...
            <div class="space-y-4">
                <div class="border-b border-gray-200">
                    <button class="flex justify-between items-center w-full py-4 text-left" onclick="toggleAnswer(this)">
                        <span class="text-2xl font-semibold text-indigo-900">How does SomaPlus insure its staff and teachers?</span>
                        <span class="text-2xl text-indigo-900">−</span>
                    </button>
                    <div class="pb-4 text-xl font-semibold hidden text-gray-600  fadeIn">
                        <p>All staff and teachers registered with SomaPlus are covered by our comprehensive occupational accidental insurance policy. This policy provides coverage for bodily injury and property damage during work-related activities. The insurance coverage amounts to $1,000,000 aggregate with $500,000 per occurrence.</p>
                    </div>
                </div>
            
                <div class="border-b border-gray-200">
                    <button class="flex justify-between items-center w-full py-4 text-left" onclick="toggleAnswer(this)">
                        <span class="text-2xl font-semibold text-indigo-900">How does SomaPlus support schools and businesses?</span>
                        <span class="text-2xl text-indigo-900">+</span>
                    </button>
                    <div class="hidden pb-4 text-xl font-semibold text-gray-600  fadeIn">
                        <p>SomaPlus offers a range of services to support schools and educational businesses, including access to vetted staff, comprehensive management tools, and insurance coverage for all registered personnel.</p>
                    </div>
                </div>
            
                <div class="border-b border-gray-200">
                    <button class="flex justify-between items-center w-full py-4 text-left" onclick="toggleAnswer(this)">
                        <span class="text-2xl font-semibold text-indigo-900">Are SomaPlus staff and teachers vetted?</span>
                        <span class="text-2xl text-indigo-900">+</span>
                    </button>
                    <div class="hidden pb-4 text-xl font-semibold text-gray-600  fadeIn">
                        <p>Yes, all staff and teachers registered with SomaPlus undergo a thorough vetting process, including background checks, qualifications verification, and interviews to ensure they meet our high standards.</p>
                    </div>
                </div>
            
                <div class="border-b border-gray-200">
                    <button class="flex justify-between items-center w-full py-4 text-left" onclick="toggleAnswer(this)">
                        <span class="text-2xl font-semibold text-indigo-900">How much do SomaPlus's services cost?</span>
                        <span class="text-2xl text-indigo-900">+</span>
                    </button>
                    <div class="hidden pb-4 text-xl font-semibold text-gray-600  fadeIn">
                        <p>SomaPlus offers competitive pricing for its range of services. The cost varies depending on the specific services required by the school or educational institution. For a detailed quote, please contact our support team.</p>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="container mx-auto px-4 py-12">
            <div class="flex flex-col md:flex-row justify-between items-center">
              ...
              <div class="w-full md:w-auto">
                <button class="w-full md:w-auto bg-indigo-900 text-white font-semibold py-3 px-6 rounded-lg hover:bg-navy-800 transition duration-300">
                  Contact Sales
                </button>
              </div>
            </div>
